...
// Copyright (c) 2017 The CAST developers
...
uint256 hashGenesisBlock("0x00000cd2934638c4f32f892c64702fa634567ac776d2cd498bad29431291318f");
static const unsigned int timeGenesisBlock = 1525698000;
...
const string strMessageMagic = "CAST Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Monday, May 4, 2018. The CAST release. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("048998fda75656132934f14dd0a6cc36f259657d099a269a7baccd4caf53c2a4b3128c9823a3fa717666828d2f2af82a8a12fd8403b95ca5a4213b6031def0b15d") << OP_CHECKSIG;
        CBlock block;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xf48ea23c34c88f24c9f6163b887ddbc745d1588e70d3302661a4f42ccfa8f2af"));
...
unsigned char pchMessageStart[4] = { 0xdf, 0xeb, 0xa6, 0xdb };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CASTMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CASTMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("CASTMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("CAST-miner");
    ...
    try { loop {
        ...
        printf("Running CASTMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
