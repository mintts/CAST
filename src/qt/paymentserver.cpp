...
const QString BITCOIN_IPC_PREFIX("CAST:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click CAST: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start CAST: click-to-pay handler");
    else
...
{
    // clicking on CAST: URLs creates FileOpen events on the Mac:
